...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_static_prefix) {
        ...
        quickElement('i', title_available, '', 'class', 'help-tooltip icon-question-sign', 'title', interpolate(gettext('This is the list of available %s. You may choose some by selecting them in the box below and then clicking the "Choose" arrow between the two boxes.'), [field_name]));
        ...
        var search_selector_img = quickElement('i', search_filter_label, '', 'class', 'help-tooltip icon-search', 'alt', '', 'title', interpolate(gettext("Type into this box to filter down the list of available %s."), [field_name]));
        ...
        quickElement('i', title_chosen, '', 'class', 'help-tooltip icon-question-sign', 'title', interpolate(gettext('This is the list of chosen %s. You may remove some by selecting them in the box below and then clicking the "Remove" arrow between the two boxes.'), [field_name]));
